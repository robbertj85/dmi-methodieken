...
export interface Methodiek {
  ...
  /** Type document uit de kolom "type" van de spreadsheet (sept 2026); indeling conform de fase 1-rapportage. */
...
export const methodieken: Methodiek[] = [
...

  {
    ...
    link: "https://www.kcbr.nl/ontwikkelen-beleid-en-regelgeving/beleidskompas",
  ...
  },
  {
    ...
    link: "https://www.grenzeloossamenwerken.nl/netwerkacademie/tools/rijksbrede-tools/het-7-cirkel-model",
  ...
  },
  {
    ...
    link: "https://www.kcbr.nl/ontwikkelen-beleid-en-regelgeving",
    remarks: "Algemene BO",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["data_gedreven"],
    description: "Meetinstrument Determinanten van Innovaties / Implementatie",
    linkText: "Het instrument: https://www.tno.nl/downloads/MIDIvragenlijst.pdf \n\nEn recent vervolg met implementatie strategieen: https://www.werkplaatssamen.nl/wp-content/uploads/2024/04/IMPLEMENTATIETOOL-V7.pdf",
  ...
  {
    id: "siaf",
    name: "Spatial Impact Assessment Framework (SIAF)",
    domain: "algemeen",
    processStep: "oplossingsrichtingen",
    policyTrack: "domein_overstijgend",
    documentType: "methodiek",
    crossCuttingThemes: ["domein_overstijgend", "openbare_ruimte"],
    description: "Het SIAF is een stapsgewijze aanpak en een evidence-based raamwerk voor hulp bij gebiedsontwikkeling. De geïntegreerde aanpak vertaalt abstracte beleidsambities naar concrete ruimtelijke behoeften en geeft inzicht in de ruimtelijke behoeften van verschillende domeinen (zoals economische ontwikkeling, energie, gezondheid en mobiliteit) en de interacties tussen deze behoeften. Zo wordt een domeinoverstijgende beoordeling van ruimtelijke ontwikkeling mogelijk. Daarbij worden synergieën en afruilen tussen domeinen expliciet gemaakt. Dit helpt stakeholders om potentiële conflicten vroegtijdig te identificeren en meer gebalanceerde, beleidsconforme oplossingen te ontwikkelen.",
    linkText: "SIAF (Spatial Impact Assessment Framework) inzetten bij gebiedsontwikkeling | Dexes.eu",
    link: "https://open.dmi.dexes.eu/nl/service/siaf-spatial-impact-assessment-framework-inzetten-bij-gebiedsontwikkeling/6a98018be34731f7e6040262",
    remarks: "",
    aiDetaillering: {
      description: "SIAF wordt door TNO als dienst aangeboden via de DMI-datacatalogus op Dexes: een gestructureerde, evidence-based aanpak voor gebiedsontwikkeling die abstracte beleidsdoelen vertaalt naar concrete ruimtelijke behoeften per domein en synergieën en afruilen tussen domeinen expliciet maakt. Voor meer informatie verwijst de catalogus naar de TNO-afdeling Sustainable Urban Mobility and Safety (SUMS). Buiten de catalogus is geen openbare documentatie gevonden.",
      organization: "TNO (via DMI-datacatalogus Dexes)",
      sources: [
        { url: "https://open.dmi.dexes.eu/nl/service/siaf-spatial-impact-assessment-framework-inzetten-bij-gebiedsontwikkeling/6a98018be34731f7e6040262", label: "SIAF inzetten bij gebiedsontwikkeling – DMI catalogus (Dexes)" },
      ],
    },
  },
...

  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "Met de stappenmethode kunnen beleidsmedewerkers tijdens het ontwikkelen van een beleidsvoorstel gericht inzicht krijgen in hoe het welzijn voor verschillende groepen mensen tot stand komt. Met andere woorden, het wordt duidelijk hoe een beleidsvoorstel bijdraagt of afbreuk doet aan het welzijn van mensen. De uitkomst van de stappenmethode is een advies over één of meerdere beleidsopties op basis van ex ante (voorafgaande) evaluaties van de effecten op het welzijn van groepen mensen.",
    linkText: "Sturen op brede welvaart met WISE Policy Making | TNO\nhttps://repository.tno.nl/SingleDoc?find=UID%2094e4c8ee-e9e1-4cc2-8694-dc5e24ee0777",
    link: "https://www.tno.nl/nl/technologie-wetenschap/exploratory-research-programmes/sturen-brede-welvaart-wise-policy-making/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    linkText: "CROW | STOMP in de praktijk",
    link: "https://www.crow.nl/kennisproducten/stomp-in-de-praktijk/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    link: "https://cvs-congres.nl/e2/site/cvs/custom/site/upload/file/cvs_2022/108.pdf",
  ...
  },
  {
    ...
    link: "https://open.rijkswaterstaat.nl/open-overheid/@77101/methodiek-evaluatie-mobiliteit-vinex/",
    remarks: "uit 1999",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["domein_overstijgend"],
    description: "Het stappenplan 'Zo werkt het - Mobiliteitsgedrag ' is gebaseerd op het Behavior Change Model (BCM). Dit is een wetenschappelijk gefundeerd verandermodel dat succesvol wordt ingezet om gedrag langdurig te veranderen. Het stappenplan bestaat uit de volgende stappen:\n1. Doelanalyse\n2. Landschapsanalyse\n3. Landschapscheck\n4. Techniekselectie\n5. Interventiedesign\n6. Borging",
    linkText: "Mobiliteitsgedrag_effectief_verbeteren.pdf",
    link: "https://zowerkthet.nl/wp-content/uploads/2023/05/Mobiliteitsgedrag_effectief_verbeteren.pdf",
    remarks: "white paper ontwikkeld door Dijksterhuis & Van Baaren in samenwerking met Breikers. Domeinoverstijdgend",
    aiDetaillering: {
  ...
  },
  {
    ...
    link: "https://www.crow.nl/actueel/integrale-toegankelijkheidsrichtlijnen-voor-openba/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["openbare_ruimte"],
    description: "Handreiking om binnen een gemeente te komen tot een een beleidsmatig verankerd en kwalitatief hoogwaardig voetgangersnetwerk. Dit netwerk bestaat uit een basisnetwerk, een hoofdnetwerk en een groen, ontspannen netwerk.",
    linkText: "CROW | Handreiking voetgangersnetwerk",
    link: "https://www.crow.nl/kennisproducten/handreiking-voetgangersnetwerk/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "Met Aanpak SPV op weg naar 0 verkeersslachtoffers in 2050! Een risicogestuurde aanpak van verkeersveiligheid biedt meer concrete aanknopingspunten om de juiste maatregelen te nemen op de juiste locaties. Door gebruik te maken van lokale en regionale informatie over risicofactoren, kan de beleidscyclus preciezer worden afgestemd.",
    linkText: "Aanpak SPV – Aanpak SPV",
    link: "https://aanpakspv.nl/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    description: "In Rotterdam zijn de wijken aan zet. De mobiliteitstransitie is volop in beweging, maar hoe zorg je ervoor dat de veranderingen ook echt aansluiten bij wat bewoners nodig hebben? Binnen de Wijkaanpak Mobiliteit werken verschillende partijen samen zoals de Veldacademie, mobiliteitsadviesbureau’s en TNO. Ideate helpt ook mee aan het mensgerichter maken van mobiliteit. Als projectleider van de pilotwijk Mathenesse en creatief strateeg binnen het programma helpen we de mobiliteitstransitie te versnellen door samen met bewoners en professionals duurzame, gedragen oplossingen te ontwikkelen. Het doel? Mobiliteit toegankelijker, leefbaarder en veiliger maken voor iedereen.",
    linkText: "Wijkaanpak Mobiliteit - Ideate",
    link: "https://ideate.nl/projecten/wijkaanpak-mobiliteit/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["openbare_ruimte", "participatie"],
    description: "Placemaking is een methode om de openbare ruimte leefbaar en succesvol te maken. Dit gebeurt op basis van de inbreng van bewoners en belangenorganisaties. Maar succesvolle ruimtes moeten ook bereikbaar zijn en met elkaar verbonden. De methode Placemaking en Mobiliteit levert een bijdrage om steden nu en in de toekomst bereikbaar én leefbaar te houden. De methode is verwoord in een handleiding die ondersteuning biedt aan gemeenten die aan de slag willen met Placemaking en Mobiliteit. Aan de hand van praktijkvoorbeelden worden de verschillende stappen van de methode nader uitgewerkt. (Author/publisher)",
    linkText: "Placemaking en mobiliteit : een handleiding met voorbeelden uit de praktijk.",
    link: "https://swov.nl/nl/publicatie/placemaking-en-mobiliteit-een-handleiding-met-voorbeelden-uit-de-praktijk",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "De werkwijzer helpt beleidsmedewerkers op gestructureerde wijze na te denken over de werking en effectiviteit van gedragsmaatregelen in verschillende situaties en op verschillende doelgroepen.",
    linkText: "Werkwijzer 'Duurzame mobiliteit en gedrag' | Rapport | Rijksoverheid.nl",
    link: "https://www.rijksoverheid.nl/documenten/rapporten/2024/06/28/werkwijzer-duurzame-mobiliteit-en-gedrag",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["data_gedreven"],
    description: "Deze werkwijzer beschrijft waar een maatschappelijke kosten-batenanalyse (MKBA) aan moet voldoen als onderbouwing bij een voorkeursbeslissing in het MIRT. De werkwijzer geldt voor MKBA’s die uitgevoerd moeten worden in de verkenningsfase van reguliere MIRT-projecten.",
    linkText: "MKBA bij MIRT-verkenningen | RWSeconomie.nl",
    link: "https://www.rwseconomie.nl/werkwijzers/mkba-bij-mirt-verkenningen",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    description: "The FESTA methodology for (Field Operational Tests (FOTs) was developed in 2008 in the European FESTA project. Field Operational Tests (FOT) are defined as: ”A study undertaken to evaluate a function, or functions, under normal operating conditions in road traffic environments typically encountered by the participants using study design so as to identify real-world effects and benefits”. Although CCAM projects will now use the Common Evaluation Methodology (EU-CEM), the handbook still contains a wealth of practical recommendations",
    linkText: "The FESTA Methodology - Connected Automated Driving",
    link: "https://www.connectedautomateddriving.eu/methodology/festa/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["data_gedreven"],
    description: "The European Common Evaluation Methodology (EU-CEM) for CCAM, developed by the FAME project, provides guidance on how to set up and carry out an evaluation.",
    linkText: "European Common Evaluation Methodology for CCAM - Connected Automated Driving",
    link: "https://www.connectedautomateddriving.eu/methodology/common-evaluation-methodology/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "GGB richt zich voornamelijk op het verbeteren van de doorstroming en de bereikbaarheid. De nieuwste versie van GGB wordt GGB+ genoemd omdat hierin ook effecten op het gebied van veiligheid en leefbaarheid zijn opgenomen.",
    linkText: "Gebiedsgericht Benutten plus Duurzaam Veilig : samenwerken aan veilige bereikbaarheid en bereikbare veiligheid : aanvulling op het Werkboek Gebiedsgericht Benutten - Rijkswaterstaat Publicatie Platform",
    link: "https://open.rijkswaterstaat.nl/@24354/gebiedsgericht-benutten-plus-duurzaam/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "Een praktische methode voor mobiliteitsprofessionals om een integraal en toekomstgericht beeld van hun mobiliteitsnetwerken op te stellen. Een multimodaal netwerkkader beschrijft de gewenste inzet en samenhang van verschillende modaliteiten (auto, openbaar vervoer, fiets en voetganger) binnen één samenhangende visie. Het vormt daarmee de vertaalslag van mobiliteitsbeleid naar concrete richtlijnen voor de inrichting en het functioneren van de netwerken. \nDe richtlijn beschrijft de gestandaardiseerde inhoud van een multimodaal netwerkkader en helpt om beleidsdoelen concreet te maken. De leidraad biedt een methodiek met uitgewerkte voorbeelden voor het opstellen van een multimodaal netwerkkader.",
    linkText: "",
  ...
  },
  {
    ...
    processStep: "interventies",
    policyTrack: "beleidsdoorwerking",
    documentType: "norm_richtlijn",
    crossCuttingThemes: ["openbare_ruimte"],
    description: "ASVV (Aanbevelingen voor Verkeersvoorzieningen Binnen de Bebouwde Kom). Dé verzamelplek voor alle kennis over verkeersvoorzieningen binnen de bebouwde kom. Of het nu gaat om het ontwikkelen van parkeerbeleid, de aanleg van een fietspad of busbaan, openbare verlichting, bewegwijzering, wet- en regelgeving of mobiliteitsbeleid: hier vind je alles wat je wilt én moet weten!",
    linkText: "CROW | Wegontwerp en weginrichting",
    link: "https://www.crow.nl/Onderwerpen/wegontwerp-en-weginrichting/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["data_gedreven"],
    description: "Handreiking met overzicht van bestaande kennis op Smart Mobility en hoe je die kennis het best kunt gebruiken. In een aantal stappen neemt de Ladder van Smart Mobility je mee om Smart Mobility zo effectief mogelijk te kunnen inzetten.",
    linkText: "home - Ladder van Smart Mobility",
    link: "https://ladder.crow-smartmobility.nl/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    linkText: "Parkeren – CROW\nParkeernormen en duurzame gebiedsontwikkeling – CROW",
    link: "https://www.crow.nl/Onderwerpen/parkeren/",
    remarks: "",
    aiDetaillering: {
      description: "CROW publiceert parkeerkencijfers en richtlijnen die gemeenten helpen om parkeernormen vast te stellen voor verschillende functies (wonen, werken, winkels etc.). De publicatie 'Parkeernormen en duurzame gebiedsontwikkeling' biedt praktische kaders. De meest recente parkeerkencijfers zijn van 2024.",
      organization: "CROW",
  ...
  },
  {
    ...
    linkText: "Anders Reizen – coalitie website",
    link: "https://www.andersreizen.nu/",
    remarks: "",
    aiDetaillering: {
      description: "Anders Reizen is een coalitie van meer dan 70 grote werkgevers in Nederland, goed voor meer dan 550.000 medewerkers. De gezamenlijke ambitie is om de CO₂-uitstoot van zakelijke mobiliteit per medewerker te halveren in 2030 ten opzichte van 2016. In 2024 had 55% van de leden het 2030-doel al behaald.",
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: [],
    description: "De Regionale Mobiliteitsprogramma’s (RMP’s) zijn een instrument dat voortkomt uit het Klimaatakkoord. Hierin maken gemeenten, provincies en regionale partners een analyse van hun mobiliteitssysteem en stellen ze ambities en doelstellingen voor de verduurzaming daarvan. Ook beschrijven ze welke maatregelen ze al uitvoeren, en formuleren ze nieuwe maatregelen passend bij hun ambities en regionale context.  Daarbij ligt de focus op het verbeteren van de leefbaarheid, bereikbaarheid, verkeersveiligheid en gezondheid en wordt tegelijkertijd voldaan aan (inter)nationale klimaatafspraken.",
    linkText: "Regionale mobiliteitsprogramma's | VNG",
    link: "https://vng.nl/artikelen/regionale-mobiliteitsprogrammas",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: [],
    description: "Handreiking voor een toekomstbestendig logistiek systeem voor het goederenvervoer.",
    linkText: "CROW | Handreiking Duurzame gebiedsontwikkeling en logistiek\nhttps://www.rijksoverheid.nl/documenten/2023/12/13/bijlage-5-handreiking-duurzame-gebiedsontwikkeling-en-logistiek",
    link: "https://www.crow.nl/kennisproducten/handreiking-duurzame-gebiedsontwikkeling-en-logistiek/",
    remarks: "CROW",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: [],
    description: "eerste aanzet op weg naar de realisatie van integrale hubs waarin ruimte, mobiliteit en energie samenkomen",
    linkText: "CROW | Handreiking Energie en mobiliteitshubs, op weg naar integrale hubs",
    link: "https://www.crow.nl/kennisproducten/handreiking-energie-en-mobiliteitshubs-op-weg-naar-integrale-hubs/",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "Praktische werkwijze om duurzaamheid in GWW projecten een plaats te geven en te koppelen aan eigen organisatiedoeleinden",
    linkText: "CROW | Handreiking Aanpak Duurzaam GWW",
    link: "https://www.crow.nl/kennisproducten/handreiking-aanpak-duurzaam-gww/",
    remarks: "",
    aiDetaillering: {
  ...
  {
    id: "rws-hinderaanpak",
    name: "RWS Hinderaanpak",
    domain: "mobiliteit",
    processStep: "beleids_probleemanalyse",
    policyTrack: "beleidsdoorwerking",
    documentType: "norm_richtlijn",
    crossCuttingThemes: ["participatie"],
    description: "Werkwijze voor instandhouden van bereikbaarheid en veiligheid tijdens werkzaamheden aan het wegennetwerk. In deze werkwijzer is de Hinderaanpak van twee sectoren opgenomen: Wegverkeer (deel A) aan de ene kant en Water en Scheepvaart (deel B) aan de andere kant.",
    linkText: "Hinderaanpak: Slim plannen, slim bouwen en slim reizen | Rijkswaterstaat Publicatie Platform",
    link: "https://open.rijkswaterstaat.nl/open-overheid/onderzoeksrapporten/@125846/werkwijzer-hinderaanpak/",
    remarks: "",
    aiDetaillering: {
      description: "De Werkwijzer Hinderaanpak van Rijkswaterstaat (2024) beschrijft hoe hinder voor weggebruikers en scheepvaart bij aanleg-, beheer- en onderhoudswerkzaamheden wordt beperkt langs drie sporen: slim plannen, slim bouwen en slim reizen. Deel A behandelt wegverkeer, deel B water en scheepvaart. Aanvullende instrumenten gaan over kosteneffectiviteit, het beoordelen van de impact op reizigers en monitoring en evaluatie.",
      organization: "Rijkswaterstaat (Ministerie van Infrastructuur en Waterstaat)",
      sources: [
        { url: "https://open.rijkswaterstaat.nl/open-overheid/onderzoeksrapporten/@125846/werkwijzer-hinderaanpak/", label: "Werkwijzer Hinderaanpak – Rijkswaterstaat Publicatie Platform" },
      ],
    },
  },
  {
    id: "handreiking-mobiliteit-duurzame-gebiedsontwikkeling",
    name: "Handreiking mobiliteit en duurzame gebiedsontwikkeling",
    domain: "mobiliteit",
    processStep: "participatie",
    policyTrack: "beleidsdoorwerking",
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["participatie", "openbare_ruimte"],
    description: "De online Handreiking mobiliteit en duurzame gebiedsontwikkeling van CROW-KpVV brengt beschikbare informatie bijeen voor iedereen die worstelt met mobiliteitsvragen bij duurzame gebiedsontwikkeling.",
    linkText: "CROW | Handreiking mobiliteit en duurzame gebiedsontwikkeling",
    link: "https://www.crow.nl/kennisproducten/handreiking-mobiliteit-en-duurzame-gebiedsontwikkeling/",
    remarks: "CROW",
    aiDetaillering: {
      description: "De handreiking (CROW-KpVV, 2020) bundelt binnen het thema Slimme duurzame verstedelijking de beschikbare kennis over mobiliteitsvraagstukken bij duurzame gebiedsontwikkeling. Ze is bedoeld voor professionals bij gemeenten, ontwikkelaars en adviseurs die mobiliteit vroegtijdig in de planvorming voor gebiedsontwikkeling willen meenemen.",
      organization: "CROW-KpVV",
      sources: [
        { url: "https://www.crow.nl/kennisproducten/handreiking-mobiliteit-en-duurzame-gebiedsontwikkeling/", label: "Handreiking mobiliteit en duurzame gebiedsontwikkeling – CROW" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: [],
    description: "Analyse van enkele van praktische implicaties van micromobiliteit door te kijken naar zes regels die herhaaldelijk worden besproken voor gedeelde micromobiliteit: snelheidslimieten, parkeren, helmen, voorlichting aan gebruikers, inzet van lokale arbeidskrachten en levenscyclusanalyse.",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: [],
    description: "Een praktische methode opgedeeld in processtappen om te bepalen of een selectief toegangs- of doseersysteem het geschikte middel is voor de eigen situatie en, zo ja, hoe dit systeem tot stand te brengen. De publicatie gaat onder meer in op de technische, juridische en verkeerskundige aspecten.",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "best_practice",
    crossCuttingThemes: ["openbare_ruimte"],
    description: "The paper discusses the importance of a dynamic curbside strategy for local authorities and how it can be successfully implemented. While previous research has focused on the traffic engineering perspective, this paper investigates five overlooked pillars that have been identified together with POLIS (local regulations, institutional arrangements, stakeholder involvement, technology and digital services, and street design) that contribute to the successful implementation of dynamic curbside management.",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "norm_richtlijn",
    crossCuttingThemes: [],
    description: "Online kennismodule dat de meest actuele richtlijnen en kennis biedt over parkeren, inclusief kennis over onder andere verschillende aspecten van parkeren (beleid en uitvoering), P+R-beleid, de parkeerkencijfers en de fietsparkeerkencijfers, fietsparkeren en vrachtautoparkeren.",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: [],
    description: "Position paper, pleidooi voor stratgische omgang met beheer en onderhoud van weginfra, inclusief stappenplan hoe te komen tot keuzes en prioritering.  als logische voortzetting van het ERF-manifest voor wegbeheer, dat een meer gedetailleerde toelichting geeft op de principes en oplossingen voor wegbeheer.\nERF is ervan overtuigd dat oplossingen voor wegbeheer bijdragen aan een duurzaam en effectief\nbeheer van een veilig en efficiënt wegennet. Als burgers, weggebruikers en belastingbetalers willen we niet\ndat dit enorme gemeenschapsgoed zijn waarde en serviceniveau verliest.",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["data_gedreven"],
    description: "Inzicht in hoe ‘Europa’ is georganiseerd op het gebied van Smart Mobility en Intelligent Transport Systems (ITS). Omdat de rol van de EU op het mobiliteitsbeleid steeds groter wordt, is de oproep aan overheden om ambities te delen en elkaar op te zoeken",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["data_gedreven"],
    description: "Data provision for Real-Time Traffic Information is regulated by the European Commission under the Intelligent Transport Systems (ITS) directive (Directive 2010/40/EU, supplemented by 2023/2661/EU) and in the Real-Time Traffic Information Delegated Act (DR2022/670). This Regulation establishes the specifications necessary to guarantee the accessibility, exchange, re-use and update of data by both data holders and data users to facilitate the provision of EU-wide real-time traffic information services, and to ensure that these services are accurate and available across borders to end users.",
    linkText: "Directive - 2010/40 - EN - EUR-Lex",
    link: "https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=uriserv:OJ.L_.2010.207.01.0001.01.ENG",
  ...
  },
  {
    ...
    link: "https://www.kimnet.nl/documenten/2026/02/12/de-mens-achter-het-reisgedrag",
    remarks: "KiM rapport",
    aiDetaillering: {
...

  {
    ...
    link: "https://www.rivm.nl/publicaties/beweging-en-veiligheid-in-wijk-handleiding-bewegingsbevorderende-en-veilige-wijken",
    remarks: "2005",
    aiDetaillering: {
  ...
  },
  {
    ...
    processStep: "oplossingsrichtingen",
    policyTrack: "beleidsontwikkeling",
    documentType: "tool_model",
    crossCuttingThemes: ["data_gedreven"],
    description: "De Groene Baten Planner is een rekenmodel van het RIVM en ondersteunt ruimtelijke planmakers bij het identificeren van de meerwaarde voor het toepassen van groen in de ruimtelijke inrichting van een stedelijke omgeving.Het moel berekent de verwachte maatschappelijk baten van het toevoegen van groen in een gebied op drie verschillende indicatoren.",
    linkText: "Groene Baten Planner | Atlas Natuurlijk Kapitaal",
    link: "https://www.atlasnatuurlijkkapitaal.nl/groene-baten-plannertool",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["openbare_ruimte"],
    description: "Proces om te komen tot onderbouwd beleid voor een beweegvriendelijke omgeving met uitlegvideo’s, beschrijvingen, concrete tips en handreikingen",
  ...
  {
    id: "gebiedscheck-gezonde-leefomgeving",
    name: "Gebiedscheck Gezonde Leefomgeving",
    domain: "gezondheid",
    processStep: "ambitie_visie_doel",
    policyTrack: "beleidsontwikkeling",
    documentType: "tool_model",
    crossCuttingThemes: ["data_gedreven"],
    description: "data en kaarten over de gezonde leefomgeving en de bevolking in een gebied.",
    linkText: "Gebiedscheck Gezonde Leefomgeving | Gids Gezonde Leefomgeving",
    link: "https://www.gezondeleefomgeving.nl/gebiedscheck",
    remarks: "",
    aiDetaillering: {
      description: "De Gebiedscheck is onderdeel van de Gids Gezonde Leefomgeving van RIVM en Rijkswaterstaat, in opdracht van het Ministerie van Infrastructuur en Waterstaat. Gebruikers kiezen een gemeente, wijk of buurt en krijgen kaarten en cijfers op basis van de Basisset Indicatoren Gezonde Leefomgeving; twee gebieden kunnen naast elkaar worden vergeleken. De tool richt zich op iedereen die werkt aan ruimtelijk beleid en plannen en is nog volop in ontwikkeling.",
      organization: "RIVM en Rijkswaterstaat (Gids Gezonde Leefomgeving)",
      sources: [
        { url: "https://www.gezondeleefomgeving.nl/gebiedscheck", label: "Gebiedscheck – Gids Gezonde Leefomgeving" },
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["participatie"],
    description: "Vanuit het gedachtegoed van Positieve Gezondheid ondersteun je bewoners om niet te focussen op ziekte en wat niet meer gaat, maar op wat nog wél kan, kansen en mogelijkheden. Met de toolkit ga je met partners uit het sociale en fysieke domein én met bewoners in gesprek. Samen kijk je naar belangen, behoeften en mogelijkheden volgens de zes dimensies. Aan de hand van een kaart van de wijk, bekijk je in groepen hoe de woon- leefomgeving anders ingericht kan worden. Welke aspecten krijgen al genoeg aandacht en welke nog niet? Het resultaat is een ruimtelijke visie met concrete voorstellen en aandacht voor de belangen van alle betrokkenen.",
    linkText: "Positieve Gezondheid in woon- en leefomgeving - Institute for Positive Health\n\nhttps://www.louisbolk.nl/projecten/positieve-gezondheid-en-leefomgeving\n\nhttps://vng.nl/artikelen/over-deze-handreiking-gezonde-leefomgeving",
    link: "https://www.iph.nl/positieve-gezondheid-in-woon-en-leefomgeving/",
    remarks: "Positieve Gezondheid is de laatste jaren HET concept geworden in het sociale domein, ontwikkeld door Machteld Huber die eerder ook de definitie van gezondheid formuleerde als \"meer dan de afwezigheid van ziekte\". PG wordt omarmd door de overheid, gemeenten en partners in het Zorgakkoord, GALA ed.",
    aiDetaillering: {
  ...
  },
  {
    ...
    description: "Wensite met links naar diverse tools en instrumenten (technieken bij beleidsontwikkeling).",
    linkText: "Gezonde leefomgeving | Loketgezondleven.nl\n\nhttps://www.gezondeleefomgeving.nl/\n\nhttps://www.loketgezondleven.nl/aanpak-gezonde-gemeente/instrumenten",
    link: "https://www.loketgezondleven.nl/gezondheidsthema/leefomgeving",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    name: "Werkboek Gezondheid en Ruimte",
    domain: "gezondheid",
    processStep: "act",
    policyTrack: "uitvoering",
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["participatie"],
    description: "inspiratie- en werkboek voor de gemeentelijke professionals – strategen en andere adviseurs die werken aan het verbinden van de domeinen sociaal en fysiek op het terrein van gezondheid en ruimte.",
    linkText: "",
  ...
  },
  {
    ...
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: ["participatie"],
    description: "Participatieve beleidsontwikkeling is een manier van beleid maken waarbij een overheid of organisatie belanghebbenden – zoals burgers, bedrijven en maatschappelijke groepen – vroegtijdig betrekt om mee te denken en mee te beslissen",
    linkText: "",
    link: "https://www.kcbr.nl/themas/themas-z/participatie-beleid-begint-met-luisteren",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    documentType: "methodiek",
    crossCuttingThemes: ["openbare_ruimte"],
    description: "Sociale veiligheid in de openbare ruimte\ndeel 3 in de reeks Hoe specificeer je dat?",
  ...
  },
  {
    ...
    linkText: "",
    link: "https://www.rvo.nl/onderwerpen/energiesysteem/integraal-programmeren",
  ...
  },
  {
    ...
    linkText: "",
    link: "https://www.pbl.nl/modellen/hestia",
  ...
  {
    id: "serious-games-energie-ruimte-warmte",
    name: "Serious Games - Energie & Ruimte en Warmte",
    domain: "energie",
    processStep: "oplossingsrichtingen",
    policyTrack: "beleidsontwikkeling",
    documentType: "tool_model",
    crossCuttingThemes: ["participatie", "openbare_ruimte"],
    description: "Game om op een laagdrempelige manier inzicht te krijgen in de ruimtelijke energietransitie. De games zijn geschikt voor iedereen: van beleidsmakers en politici tot bewoners en scholieren. Deelnemers werken tijdens de serious games met duurzame energie of warmte, op basis van een kaart van hun eigen regio. Dit maakt de uitdagingen, mogelijkheden en ruimtelijke impact van verschillende energieopties direct visueel en tastbaar. Het stimuleert levendige discussies en helpt om de energietransitie begrijpelijker en concreter te maken.",
    linkText: "Serious games – Generation.Energy",
    link: "https://generation.energy/energiestrategieen/serious-games/",
    remarks: "",
    aiDetaillering: {
      description: "Generation.Energy biedt twee serious games aan. In 'Elektriciteit & Ruimte' bepalen deelnemers op een kaart van hun eigen regio waar ruimte is voor hernieuwbare opwek en of de regio energieneutraal kan worden. In 'Warmte' koppelen zij warmtebronnen zoals geothermie, restwarmte en biogas aan de gebouwde omgeving, rekening houdend met de ligging van warmtevraag en -aanbod. Sessies duren een half uur tot een dagdeel en worden begeleid door Generation.Energy en partners.",
      organization: "Generation.Energy",
      sources: [
        { url: "https://generation.energy/energiestrategieen/serious-games/", label: "Serious games – Generation.Energy" },
      ],
    },
  },
  {
    id: "nzies",
    name: "NZIES (Net-Zero Integrated Energy Systems)",
    domain: "energie",
    processStep: "oplossingsrichtingen",
    policyTrack: "beleidsontwikkeling",
    documentType: "handreiking_inspiratie",
    crossCuttingThemes: [],
    description: "Afwegingskader voor het combineren van verschillende energie-systemen",
    linkText: "Net-Zero Intelligent Energy System: Road to a Successful Carbon Neutral Future | IEEE Conference Publication | IEEE Xplore",
    link: "https://ieeexplore.ieee.org/document/9738663",
    remarks: "",
    aiDetaillering: {
      description: "De gelinkte bron is een IEEE-conferentiepaper (2022) waarin een Net-Zero Intelligent Energy System (NZIES) wordt voorgesteld op basis van de integratie van meerdere energiedragers. De analytische architectuur richt zich op end-to-end verbetering van energie-efficiëntie, koolstofbeheer over de volledige levenscyclus en samenwerking tussen koolstof- en elektriciteitshandel. Een casus van een net-zero smart campus dient als praktijkvoorbeeld voor planning en fasering.",
      organization: "IEEE (wetenschappelijke publicatie)",
      sources: [
        { url: "https://ieeexplore.ieee.org/document/9738663", label: "Net-Zero Intelligent Energy System – IEEE Xplore" },
      ],
    },
  },
  {
    id: "ontwerpend-onderzoek-ruimte-energie",
    name: "Ontwerpend Onderzoek Ruimte en Energie",
    domain: "energie",
    processStep: "probleemanalyse",
    policyTrack: "beleidsontwikkeling",
    documentType: "tool_model",
    crossCuttingThemes: ["data_gedreven", "openbare_ruimte"],
    description: "Ontwerpend onderzoek is en combinatie van empirisch onderzoek en ruimtelijk ontwerp. Dit betekent creatief maatwerk waarbij de visualisatie van informatie centraal staat. Het geeft inzicht in de huidige situatie en de mogelijkheden vooor het energiesysteem. Door middel van GIS-analyses worden gegevens gevisualiseerd, patronen geidentificeert en ruimtelijke relaties begrijpelijk.",
    linkText: "Ruimte en energie – Generation.Energy",
    link: "https://generation.energy/ruimte-en-energie/",
    remarks: "",
    aiDetaillering: {
      description: "Generation.Energy combineert empirisch onderzoek met ruimtelijk ontwerp. Met GIS-analyses worden geodata en vakkennis gecombineerd tot herhaalbare en herbruikbare analyses die patronen en ruimtelijke relaties zichtbaar maken en de impact van beleidskeuzes op kaart tonen. Producten zijn onder meer scenariokaarten, datavisualisaties, serious games en het interactieve platform GE MAPS, ingezet in workshops met meerdere stakeholders.",
      organization: "Generation.Energy",
      sources: [
        { url: "https://generation.energy/ruimte-en-energie/", label: "Ruimte en energie – Generation.Energy" },
      ],
    },
  },
  {
    ...
    documentType: "tool_model",
    crossCuttingThemes: ["data_gedreven", "evaluatie"],
    description: "Online informatie over de CO2-uitstoot, energiegebruik, opwek van hernieuwbare energie en een scala aan onderliggende indicatoren voor alle gemeenten, regio’s en provincies. Een groot deel van de gegevens is ook beschikbaar voor alle buurten en wijken. Met behulp van de Klimaatmonitor kan de voortgang van de energietransitie in alle gemeenten, regio’s en provincies in Nederland gemonitord worden. De Klimaatmonitor laat zien hoe de situatie van de energietransitie er is en hoe die zich in de afgelopen jaren heeft ontwikkeld. Hiermee biedt de Klimaatmonitor basismateriaal voor beleidsvoorbereiding, -bijsturing en -evaluatie voor verschillende partijen.",
    linkText: "Regionale klimaatmonitor | Klimaatmonitor",
    link: "https://klimaatmonitor.databank.nl/",
    remarks: "",
    aiDetaillering: {
      description: "De Klimaatmonitor is een databank van de Rijksoverheid met drie hoofdrapportages: energiegebruik (aardgas, elektriciteit, brandstoffen, hernieuwbare warmte), hernieuwbare opwek (zon, wind, biomassa, geothermie, water) en CO2-uitstoot uit fossiele brandstoffen. De gegevens zijn beschikbaar voor gemeenten, regio's en provincies en grotendeels ook voor wijken en buurten. De data komt mede tot stand via VIVET, een samenwerking van CBS, Kadaster, Netbeheer Nederland, PBL en RVO.",
      organization: "Rijksoverheid (Rijkswaterstaat), data via VIVET-partners",
      sources: [
        { url: "https://klimaatmonitor.databank.nl/", label: "Klimaatmonitor – databank" },
      ],
    },
  },
  ...
  },
  {
    ...
    linkText: "https://www.hdsr.nl/publish/pages/114380/2023_03_23_handboek_water_in_ruimtelijke_plannen_spreads.pdf   \n\nhttps://www.hdsr.nl/publish/pages/114380/2023_02_08_factsheets_handboek_water_in_ruimtelijke_plannen.pdf",
  ...
  },
  {
    ...
    crossCuttingThemes: ["openbare_ruimte"],
    description: "",
    linkText: "handreiking_weging_waterbelang_hoofdtekst_definitieve_versie_met_voorkant.pdf",
    link: "",
    remarks: "",
    aiDetaillering: {
  ...
  },
  {
    ...
    linkText: "https://klimaatadaptatienederland.nl/actueel/actueel/nieuws/2023/webinar-landelijke-maatlat-gemist/\n\nhttps://klimaatadaptatienederland.nl/publish/pages/218475/1286065-landelijke-maatlat-overzichtstabel-20221202-tauw-arcadis.pdf\n\nhttps://klimaatadaptatienederland.nl/publish/pages/218475/1286065-landelijke-maatlat-factsheets-en-overzichtstabel-20230228-tauw-arcadis.pdf\n\nhttps://klimaatadaptatienederland.nl/publish/pages/218475/r001-1286065jmz-v01-bouwstenenrapport-landelijke-maatlat-20221202-tauw-arcadis.pdf",
  ...
  },
  {
    ...
    linkText: "",
    link: "https://www.deltares.nl/expertise/publicaties/gereedschapskist-water-en-bodem-sturend-voor-onderbouwing-en-geleiding",
    remarks: "",
    aiDetaillering: {
...
export const documentTypeLabels: Record<DocumentType, string> = {
  methodiek: "Methodiek",
  handreiking_inspiratie: "Handreiking / inspiratie",
  best_practice: "Best practice",
  norm_richtlijn: "Norm / richtlijn",
  tool_model: "Tool / model",
};

export const documentTypeColors: Record<DocumentType, string> = {
  methodiek: "bg-[#9DC3E6] text-[#1F3B5C]",
  handreiking_inspiratie: "bg-[#A9DFBF] text-[#1E5631]",
  best_practice: "bg-[#B4B7F2] text-[#2E2E7A]",
  norm_richtlijn: "bg-[#D2B4DE] text-[#4A235A]",
  tool_model: "bg-[#F9CBA7] text-[#7B3F00]",
};
